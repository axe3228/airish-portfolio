        ...
        <section className="max-w-[1440px] mx-auto px-5 flex justify-between">
            ...
            <div className="flex flex-col items-end justify-center">
                ...
                <div className="mt-[90px]">
                    <button className="w-[210px] font-darkergrotesque-500 text-primary border-2 
                        border-primary text-[20px] pb-[15px] pt-[10px] rounded-tl-[20px] rounded-br-[20px] mr-[20px]">ABOUT ME</button>
